    <?php include "../header.php"; ?>
      ...
      <div class="row">
        <div class="col-md-4 hidden-xs">
          ...
          <div class="reduction" style="border: 2px solid #33a6e7; width: 425px; text-align: center;">
  ...
  @-webkit-keyframes reduction {
    ...
    100% { -webkit-transform: scale(.01); }
        ...
        <div class="visible-xs col-xs-12">
          <div class="reduction" style="border: 2px solid #33a6e7; width: 350px; text-align: center;">
