    <?php include "../header.php"; ?>
      ...
      <div class="row">
        <div class="col-md-4 hidden-xs">
          ...
          <div style="text-align: center; margin: 20px;">
            <img class="jump" src="../images/Facebook.jpg">
            <img class="jump" src="../images/Youtube.png">
            <img class="jump" src="../images/GooglePlus.png">
            <img class="jump" src="../images/Twitter.jpg">
            <img class="jump" src="../images/Linkedin.png">
          </div>
        </div>
  ...
  /* Jump - coded by Helias - css3.openprogrammers.it */
  .jump {
    transition: all 0.2s;
  }
  .jump:hover {
